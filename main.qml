...
ApplicationWindow {
    ...
    MediaPlayer {
        ...
        property string song_name: playlist.currentItemSource.toString()
    ...
    Image {
        ...
        source: "qrc:/png-transparent-color-drawing-headphones-illustration-musical-note-game-photography-stage.png"
        ...
        Connections{
            ...
            onPositionChanged:{
                ...
                if(progresstime.value==0 && root.visibility == Window.Hidden && (player.metaData.author == undefined || player.title == undefined))
                    systemTray.messege(letter,player.song_name.replace(/.*\//,""))
